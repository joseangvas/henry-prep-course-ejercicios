...
console.log(devolverUltimoElemento([5, 8, 4, 12]));
...
console.log(arrayContiene([4, 5, 8, 12, 20], 1));
...
console.log(agregarNumeros([4, 5, 3]));
...
console.log(promedioResultadosTest([12,16,19,18]));
...
console.log(numeroMasGrande([15, 20, 18, 14]));
...
console.log(multiplicarArgumentos(3,4,5));
...
console.log(cuentoElementos([19, 20, 16, 18, 21]));
